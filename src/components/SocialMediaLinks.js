...
function SocialMediaLinks(){
    const iconsize = "24px"
    return(
        <div className="link-logo-section">
            <div className = "link-logo">
                <a href="https://www.linkedin.com/in/jeremy-chow/">
                    <svg
                        alt="linked-in" 
            ...
            <div className = "link-logo">
                <a href="https://github.com/jeremyrchow">
                    <svg 
                        xmlns="http://www.w3.org/2000/svg" 
                        width={iconsize} 
                        viewBox="0 0 24 24">
            ...
            <div className = "link-logo">
                <a href="https://medium.com/@jeremyrchow">
                    <svg 
                        width={iconsize}
                        xmlns="http://www.w3.org/2000/svg"
                        fillRule="evenodd" 
            ...
            <div className = "link-logo">
                <a href = "https://twitter.com/jeremyrchow">
                    <svg 
                        xmlns="http://www.w3.org/2000/svg" 
                        width={iconsize} 
                        viewBox="0 0 24 24">
